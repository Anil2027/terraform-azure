...
resource "azurerm_windows_web_app" "companyapp23451112" {
  name                = "companyapp23451112"
  resource_group_name = local.resource_group_name
  location            = local.location
...
resource "azurerm_app_service_source_control" "appservice_sourcecontrol" {
  app_id   = azurerm_windows_web_app.companyapp23451112.id
  repo_url = "https://github.com/Anil2027/terraform-azure/"
  branch   = "master"
